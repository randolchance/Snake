...
#ifndef SNAKE_BASESTATE_H
#define SNAKE_BASESTATE_H
...
public:
    explicit BaseState(StateManager* l_stateManager): m_stateMgr(l_stateManager), m_transparent(false), m_transcendent(false) { }
    virtual ~BaseState() { }
